...
namespace BookStoreMyApp.Controllers
{
    ...
    public class RoleController : ControllerBase
    {
        ...
        public RoleController(BookstoreDBContext context, IUriService uriService, IMapper mapper, IWebHostEnvironment webHostEnvironment)
        {
            _context = context;
            _mapper = mapper;
        ...
        public async Task<IActionResult> GetAll([FromQuery] PaginationQuery filter)
        {
            ...
            var pagedData = await _context.Roles
                .Where(s =>
                s.RoleName!.Contains(filter.Text))
